<div class="row padding-1 p-1">
    <div class="col-md-12">
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="dni_medico" class="form-control @error('dni_medico') is-invalid @enderror"
                value="{{ old('dni_medico', $medico->dni_medico) }}" id="dni_medico" placeholder="Dni Medico"
                @if(isset($editMode) && $editMode) disabled @endif>
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="nombre" class="form-control @error('nombre') is-invalid @enderror"
                value="{{ old('nombre', $medico->nombre) }}" id="nombre" placeholder="Nombre">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="especialidad" class="form-control @error('especialidad') is-invalid @enderror"
                value="{{ old('especialidad', $medico->especialidad) }}" id="especialidad" placeholder="Especialidad">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="time" name="horario_inicio" class="form-control @error('horario_inicio') is-invalid @enderror"
                value="{{ old('horario_inicio', $horario_inicio) }}" id="horario_inicio" step="1800">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="time" name="horario_fin" class="form-control @error('horario_fin') is-invalid @enderror"
                value="{{ old('horario_fin', $horario_fin) }}" id="horario_fin" step="1800">
