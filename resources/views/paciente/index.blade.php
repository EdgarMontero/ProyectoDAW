                            ...
                            <tbody>
                                @foreach ($pacientes as $paciente)
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{ route('pacientes.destroy', $paciente->dni_paciente) }}"
                                                method="POST">
                                                <a class="btn btn-sm btn-primary"
                                                    href="{{ route('pacientes.show', $paciente->dni_paciente) }}"><i
                                                        class="fa fa-fw fa-eye"></i> {{ __('Mostrar') }}</a>
                                                <a class="btn btn-sm btn-success"
                                                    href="{{ route('pacientes.edit', $paciente->dni_paciente) }}"><i
                                                        class="fa fa-fw fa-edit"></i> {{ __('Editar') }}</a>
                                                <a class="btn btn-sm btn-info"
                                                    href="{{ route('pacientes.showConsultas', $paciente->dni_paciente) }}"><i
...
<script>
    $(document).ready(function () {
        ...
        $('.delete-button').on('click', function (e) {
            ...
            var confirmDelete = confirm('¿Estás seguro de que deseas eliminar este paciente? Se eliminarán todas las consultas relacionadas y las relaciones con los medicos.');
            if (confirmDelete) {
                form.submit();
            }
        });
